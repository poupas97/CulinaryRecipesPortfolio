...
import { getIngredientAction, ingredientsSelectors, resetIngredientsAction, saveIngredientAction, } from '../../store/ingredients';
...
const IngredientsEdit = ({
  history, getIngredient, ingredient, updateIngredient, saved, loading,
}) => {
  const { id } = useParams();
